...
module.exports = {
  ...
  state: {
    selectedAudienceId: "creator",
    selectedPacketId: "housing",
    selectedClaimIndex: 0,
    selectedFormat: "creator",
    ...
    history: [
      {
        ...
        detail: "Creator mode with the housing packet is ready for review."
      }
    ],
    lastSavedAt: "2026-03-16T20:00:00.000Z"
  }
};
